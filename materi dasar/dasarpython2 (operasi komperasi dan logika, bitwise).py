...
# is dan == hampir sama 
# tapi yang membedakan yaitu jumlah nilai dan bentuk dari objeknya
#Jadi, Kapan Pakai is dan ==?
'''
✅ Gunakan == kalau kamu hanya ingin tahu apakah nilai dua variabel sama.
✅ Gunakan is kalau kamu benar-benar ingin tahu apakah dua variabel menunjuk ke objek yang sama dalam memori (penting untuk tipe data mutable seperti list, dictionary, dll.).
'''
a = 3
b = 3
